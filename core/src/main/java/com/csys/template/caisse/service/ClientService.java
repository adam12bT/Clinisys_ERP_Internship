...
import com.csys.template.caisse.factory.ClientFactory;
import com.csys.template.caisse.repository.ClientRepository;
...
public class ClientService {
  ...
  public ClientDTO update(ClientDTO clientDTO) {
    ...
    Client inBase= clientRepository.findById(clientDTO.getNumDoss()).orElse(null);
