...
<html>
    <head>
        ...
        <title><spring:message code="template.Acceuil.User"/></title>
        <style>
            .css-error{
            ...
            #tableListUser >thead > tr th:nth-child(1),
            #tableListUser >tbody > tr td:nth-child(1){
                width: 20%!important;
            }
            #tableListUser >thead > tr th:nth-child(2),
            #tableListUser >tbody > tr td:nth-child(2){
                width: 30%!important;
            }      
            #tableListUser >thead > tr th:nth-child(3),
            #tableListUser >tbody > tr td:nth-child(3){
                width: 50%!important;
            }           
            ...
            #tableListUser >thead, #tableListUser >tbody tr {
                display: table;
                table-layout: fixed;
            }
            #tableListUser >thead {
            ...
            #tableListUser >tbody tr {
                width: 100%;
            }

            #tableListUser > tbody > tr > td,
            #tableListUser > tbody > tr > th,
            #tableListUser > tfoot > tr > td,
            #tableListUser > tfoot > tr > th,
            #tableListUser > thead > tr > td,
            #tableListUser > thead > tr > th {
                ...
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right: 2px;">
                    <div class="jarviswidget jarviswidget-color-redLight"  data-widget-editbutton="false" data-widget-deletebutton="false">
                        <header class='screen' id="bntContainer">
                            ...
                            <h2><strong>Gestion des utilisateurs</strong></h2>
...
<!--                            <a href="javascript:void(0);" class="btn btn-primary" id="btn_Exporter" style="float: right;"> <span class="widget-icon"><i class="fa fa-list"></i></span>&nbsp;&nbsp; Excel</a>
        ...
        <div class="modal fade screen" id="modalUser" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog centre_screen" style="width: 50%;">
                <div class="modal-content">
                                ...
                                <div class="row   form-group" style="margin-bottom: 0px; padding-bottom: 0px;" >
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label class="col-md-4 control-label">Login<span class="champOblig">*</span></label>
                                            <div class="col-md-6  input-group">
                                                <input id="username" type="text"   data-mask-clearifnotmatch="true" class="form-control input-xs input-code">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6" > 
                                            <label class="col-md-3 control-label">Mot de passe<span class="champOblig">*</span></label>
                                            <div class="col-md-8 input-group">
                                                <input  id="password" maxlength="100" type="text"   data-mask-clearifnotmatch="true" class="form-control input-xs" >
                                            </div>
                                        </div>
                                    </div>   
                                </div>
                                <div class="row   form-group" style="margin-bottom: 0px; padding-bottom: 0px;" >
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label class="col-md-2 control-label">Description<span class="champOblig">*</span></label>
                                            <div class="col-md-10  input-group">
                                                <input id="description" type="textarea"   data-mask-clearifnotmatch="true" class="form-control input-xs input-code">
                                            </div>
                                        </div>
                                    </div>   
                                </div>   
                    ...
                    <div  class="modal-footer" id="modalFooter" style="padding-top: 5px;padding-bottom: 5px;">                                                
                        ...
                        <button id="btnCloseModalCategorie" type="button" class="btn btn-default" onClick="$('#modalUser').modal('hide');"><i class="fa fa-times"></i>&nbsp; Fermer</button>                                       
                    </div> 
                </div>
            </div>
        </div>
        ...
        <script src="body_page_js/User.js?version=<%=date%>"></script>
        <script src="body_page_js/User_function.js?version=<%=date%>"></script>
