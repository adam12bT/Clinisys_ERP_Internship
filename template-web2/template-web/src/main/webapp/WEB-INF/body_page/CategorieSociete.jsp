...
<html>
    <head>
        ...
        <title><spring:message code="template.Acceuil.CategorieSociete"/></title>
        <style>
            .css-error{
            ...
            #tableListCategorieSociete >thead > tr th:nth-child(1),
            #tableListCategorieSociete >tbody > tr td:nth-child(1){
                width: 10%!important;
            }
            #tableListCategorieSociete >thead > tr th:nth-child(2),
            #tableListCategorieSociete >tbody > tr td:nth-child(2){
                width: 30%!important;
            }      
            #tableListCategorieSociete >thead > tr th:nth-child(3),
            #tableListCategorieSociete >tbody > tr td:nth-child(3){
                width: 25%!important;
            }           
            #tableListCategorieSociete >thead > tr th:nth-child(4),
            #tableListCategorieSociete >tbody > tr td:nth-child(4){
                width: 25%!important;
            }    
            #tableListCategorieSociete >thead > tr th:nth-child(5),
            #tableListCategorieSociete >tbody > tr td:nth-child(5){
                width: 10%!important;
            }              
            #tableListCategorieSociete  >tbody {
                flex: 1 1 auto;
                width: 100%;
                display: block;
                overflow-y: scroll;
            ...
            #tableListCategorieSociete {
                display: flex;
                flex-flow: column;
                height: 100%;
                width: 100%;
            }
            #tableListCategorieSociete >thead, #tableListCategorieSociete >tbody tr {
                display: table;
                table-layout: fixed;
            }
            #tableListCategorieSociete >thead {
                /* head takes the height it requires, 
                and it's not scaled when table is resized */
                width: calc(100% - 0.4em ) !important;
                flex: 0 0 auto;
            }
            #tableListCategorieSociete >tbody tr {
                width: 100%;
            }

            #tableListCategorieSociete > tbody > tr > td,
            #tableListCategorieSociete > tbody > tr > th,
            #tableListCategorieSociete > tfoot > tr > td,
            #tableListCategorieSociete > tfoot > tr > th,
            #tableListCategorieSociete > thead > tr > td,
            #tableListCategorieSociete > thead > tr > th {
    ...
    <body class="styleCsys" > 
                ...
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right: 2px;">
                    <div class="jarviswidget jarviswidget-color-redLight"  data-widget-editbutton="false" data-widget-deletebutton="false">
                        <header class='screen' id="bntContainer">
                            ...
                            <h2><strong>Gestion des catégories des sociétés</strong></h2>
                        ...
                        <div style="min-height: calc(100vh - 55px);">
                            <div class="widget-body screen col-md-12">
                                ...
                                <div class="row">
                                    <div  id="_grid_ListCategorieSociete" >
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div  class="modal-footer" style="padding: 1px 20px 4px;">
                        <div class="row"><br>
                            <div style="padding: 1px 20px 4px;" align="right">
                                ...
                                <button type="button" class="btn btn-default" onClick="$('#addConfirm').modal('hide');$('#modalCategorieSociete').modal('show');"><i class="fa fa-times"></i>&nbsp; Fermer</button>
                            </div>
                        </div>
                    </div> 
                </div>
        ...
        <div class="modal fade screen" id="modalCategorieSociete" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog centre_screen" style="width: 50%;">
                <div class="modal-content">
                    ...
                    <div  class="modal-footer" id="modalFooter" style="padding-top: 5px;padding-bottom: 5px;">                                                
                        ...
                        <button id="btnCloseModalCategorie" type="button" class="btn btn-default" onClick="$('#modalCategorieSociete').modal('hide');"><i class="fa fa-times"></i>&nbsp; Fermer</button>                                       
                    </div> 
                </div>
            </div>
        </div>
        ...
        <script src="body_page_js/CategorieSociete.js?version=<%=date%>"></script>
        <script src="body_page_js/CategorieSociete_function.js?version=<%=date%>"></script>
