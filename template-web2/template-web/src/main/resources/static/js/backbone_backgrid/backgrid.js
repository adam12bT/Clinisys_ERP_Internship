        ...
        saveOrCancel: function (e) {
            ...
            if (command.moveUp() || command.moveDown() || command.moveLeft() || command.moveRight() ||
                ...
                if (_.isUndefined(newValue)) {
                    ...
                    model.set(column.get("name"), newValue, {validate: true});//ferou9
...
//        },
        ...
        render: function () {
            ...
            this.$el.append('<form class="smart-form" style="margin-left: 40%;margin-top: -4px;"><fieldset style="background-color: transparent;"><div class="row"><section class="col col-5"><label class="checkbox"><input class="isPrixRef" type="checkbox" name="checkbox"><i></i></label></section></div></fieldset></form>');
        ...
        saveOrCancel: function (e) {
            ...
            if (command.save() || command.moveLeft() || command.moveRight() || command.moveUp() ||
                ...
                e.preventDefault();
                e.stopPropagation();
                var val = formatter.toRaw($el.find('input[type="checkbox"]').prop("checked"), model);
    ...
    var BooleanCell = Backgrid.BooleanCell = Cell.extend({
        ...
        render: function () {
            ...
            var editable = Backgrid.callByNeed(column.editable(), column, model);
            var data = this.formatter.fromRaw(model.get(column.get("name")), model);
            this.$el.append('<form class="smart-form"><fieldset style="background-color: transparent;margin-left: 10px;"><div class="row"><section ><center><label class="checkbox"><input type="checkbox" name="checkbox"><i></i></label></center></section></div></fieldset></form>');
            this.$el.find('input[type="checkbox"]').prop("checked", data);
            this.$el.find('input[type="checkbox"]').prop("disabled", editable);
            this.delegateEvents();
            return this;
        }
 ...
 /**
    ...
    var Row = Backgrid.Row = Backbone.View.extend({
        ...
        render: function () {
            ...
            for (var i = 0; i < this.cells.length; i++) {
                ...
                if (!this.cells[i].column.get("renderable"))
                    this.cells[i].$el.hide();
            }
    ...
    var Body = Backgrid.Body = Backbone.View.extend({
        ...
        moveToNextCell: function (model, column, command) {
            ...
            this.rows[i].cells[j].exitEditMode(command);//marwen
