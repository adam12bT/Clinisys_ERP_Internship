    ...
    $.fn.excelexportjs = function (options) {
        ...
        function ConvertDataStructureToTable() {
            ...
            $($settings.columns).each(function (key, value) {
                if (this.ishidden != true) {
                    result += "<th";
                    if (this.width != null) {
                        result += " style='width: " + this.width + ";background-color:#4CAF50;color: white;'";
                    } else {
                        result += " style='background-color:#4CAF50;color: white;' ";
                    }
                    result += ">";
        ...
        function exportToExcelIE(table) {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./))      // If Internet Explorer
            {
                ...
                sa = window.open('data:application/vnd.ms-excel,' + encodeURIComponent(tab_text), 'toolbar=0, location=0, directories=0, status=0, scrollbars=0, resizable=2, copyhistory=0, menuBar=0, width=600, height=550, left=400, top=250');
