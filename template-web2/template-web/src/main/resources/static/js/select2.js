...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatMatches: function (matches) { return matches + " resultats disponibles, veuillez utiliser et les touches fléchées pour naviguer."; },//results are available, use up and down arrow keys to navigate.
        formatNoMatches: function () { return "Aucune correspondance trouvée"; },//No matches found
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Veuillez entrer " + n + " ou plus de caractère" + (n == 1? "" : "s"); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "Veuillez supprimer " + n + " caractère" + (n == 1? "" : "s"); },//Please delete " + n + " character"
        formatSelectionTooBig: function (limit) { return "Vous pouvez sélectionner  seulement " + limit + " élément" + (limit == 1 ? "" : "s"); },//You can only select " + limit + " item"
        formatLoadMore: function (pageNumber) { return "Chargement de plus de résultats…"; },//Loading more results
        formatSearching: function () { return "Recherche en cours…"; },//Searching
